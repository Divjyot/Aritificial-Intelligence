...
public class InputGenerator {
    ...
    private static int num_file = 1000;
    ...
    private static void InputStructure(int lv) throws IOException {
        String inputFile= System.getProperty("user.dir") + "/examples/level_" + lv + "/input_lvl" + lv + ".txt";
        ProblemSpec ps = new ProblemSpec(inputFile);
        getInputFormat(ps);
        //number of input files generate

        for (int num = 0; num< num_file; num++) {
            String newInputFile =  System.getProperty("user.dir") + "/aitwo-mcts/examples/level_" + lv + "/input_lvl" + lv + "_"+num+".txt";
